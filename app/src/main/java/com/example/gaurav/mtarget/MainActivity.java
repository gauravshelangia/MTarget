...
public class MainActivity extends AppCompatActivity {
    ...
    ArrayList<Listitem> listitem1 = new ArrayList<Listitem>();
    /**
    ...
    public void Submit_grid_detail(View v){
        Toast.makeText(getApplicationContext(),"submitting details ", Toast.LENGTH_LONG).show();
    }
